...
from picoweb_utils import parse_qs
...
class WebApp:
    ...
    def option_response(self,reader,writer):
    ...
    def run(self, host="127.0.0.1", port=8081, debug=False, lazy_init=False, log=None,loop=None):
